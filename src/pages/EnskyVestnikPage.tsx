    ...
    <div className="vestnik-shell min-h-full bg-[#FAF9F6] pb-10 text-[#1a1a1a]">
      ...
      <article className="px-4">
        ...
        <h2 className="vestnik-headline mb-4 text-[26px] leading-[1.15] font-bold text-[#111827]">
          Полиция объявила в розыск мужчину, подозреваемого в убийстве
        </h2>
        ...
        <p className="vestnik-lead mb-4 text-[17px] leading-relaxed font-medium text-[#111827]">
          Управление МВД по Энской области разыскивает 48-летнего мужчину, которого подозревают
        ...
        <div className="vestnik-body space-y-4 text-[15px] leading-[1.7] text-[#374151]">
          ...
          <p>
            Жертвой, по данным источников, близких к следствию, стала его любовница — 34-летняя
            женщина, тело которой нашли в частном доме на окраине Энска. Предварительная
            причина смерти — ножевые ранения.
          </p>
          <p>
